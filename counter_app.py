...
def Stream():
    ...
    st.text("This application will track how many customer enter & exit your premise")
    ...
    if col1.button('Start ▶️') and not col2.button("Stop ⏹️"):
        ...
        while True:
            ...
            for (i, (k, v)) in enumerate(info):
                text = "{}: {}".format(k, v)
                cv2.putText(frame, text, (10, H - ((i * 20) + 20)), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 250), 2)
